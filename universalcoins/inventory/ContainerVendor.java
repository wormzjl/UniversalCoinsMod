...
public class ContainerVendor extends Container {
	...
	public ContainerVendor(InventoryPlayer inventoryPlayer, TileVendor tEntity) {
		...
		addSlotToContainer(new Slot(tileEntity, TileVendor.itemSellingSlot, 8, 17));
		addSlotToContainer(new UCSlotCoinOutput(tileEntity, TileVendor.itemCoinOutputSlot1, 133, 57));
		addSlotToContainer(new UCSlotCoinOutput(tileEntity, TileVendor.itemCoinOutputSlot2, 151, 57));
